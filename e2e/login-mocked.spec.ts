...
test("login flow with mocked Directus", async ({ page }) => {
  ...
  // Wait for the app to load and process authentication
  await page.waitForLoadState("networkidle");
  
  // Wait a bit more for React to process the authentication state
...
test("login with invalid credentials shows error (mocked)", async ({
  page,
}) => {
  // Mock failed login
  await page.route("**/auth/login", async (route) => {
